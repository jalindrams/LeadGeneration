# Micraft Growth Engine — Locked System Architecture v3

> **Status:** Constraints Locked · **Date:** 2026-04-18 · **Author:** System Architect
> **Change:** Rebuilt with ₹10K–25K/month budget, HubSpot Free, ICP locked
...
| **Geography** | India (Tier 1 + Tier 2 manufacturing cities) |
...
> [!NOTE]
> Most questions are now answered. These remain:

| # | Question | Why It Matters |
|---|---|---|
| Q1 | **Is there an existing customer list** for look-alike modeling? | Dramatically improves scoring when we reach ML phase |
| Q2 | **Which cities/states to target first?** (Pune, Chennai, Ahmedabad, Coimbatore, Ludhiana?) | Determines initial Google Maps queries and IndiaMART search terms |
| Q3 | **Will a team member handle manual enrichment?** (or do we hire a researcher?) | Human Intelligence Queue needs someone assigned |
| Q4 | **Do you have a Twilio account** or should we set one up? | For WhatsApp hot lead alerts |
| Q5 | **Any existing domain/email for outreach?** (e.g. sales@micraftsolutions.com) | SMTP setup for email outreach and sender reputation |
| Q6 | **VPS preference?** (DigitalOcean / Hetzner / AWS Lightsail / existing server?) | Infrastructure provisioning |
| Q7 | **Timeline expectation?** MVP in 2 weeks? Full system in 8 weeks? | Determines Phase 1 scope |

---

## 12. Key Decisions (LOCKED + PENDING)
...
| D5 | Qualified Lead Def | ✅ **LOCKED** | ICP match + decision-maker + verified contact |
| D6 | Budget | ✅ **LOCKED** | ₹10K–25K/month |
| D7 | Enrichment Strategy | ✅ **LOCKED** | Scraping + website extraction + manual (minimize paid APIs) |
| D8 | Sales Capacity | ✅ **LOCKED** | 2 reps, 50–60 leads/day |
| D9 | Hosting | ⏳ Pending | Recommend: Single VPS (₹2K–4K/mo) |
| D10 | Alert Channels | ⏳ Pending | Recommend: WhatsApp (Twilio) + Slack |
| D11 | Target Cities | ⏳ Pending | Recommend: Pune, Chennai, Ahmedabad, Coimbatore, Ludhiana |
| D12 | Manual Research Owner | ⏳ Pending | Needs someone assigned |

---

> [!CAUTION]
> **The ₹10K–25K budget works ONLY because we're going scraping-first with manual fallback.** If IndiaMART or JustDial block us hard, the fallback is Google Maps (free API) + manual research. The system is designed to degrade gracefully, not fail.

---

> [!TIP]
> **Next step:** Answer Q1–Q7 above, lock D9–D12, then say **"Start Build"** and we begin Phase 1 execution immediately.
